...
// var helloMessage = sayHello("Javier");
...
//  alert("You owe $" + calculateTip(tipPercentage, totalBill).toFixed(2))
...
function applyDiscount (priceBefore, discountPercentage) {
    return priceBefore - (priceBefore * discountPercentage)
